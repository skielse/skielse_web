package com.ski.estate.oldhouse.processor;

import com.ski.estate.oldhouse.bean.House;
import com.ski.estate.utils.StringUtil;
import lombok.Data;
...
public class HouseProcessor implements PageProcessor {
    ...
    private Site site = Site.me().setRetryTimes(3).setSleepTime(500).addHeader("Accept-Encoding", "gzip, deflate, br").addHeader("Accept-Language", "zh-CN,zh;q=0.9").addHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3").addHeader("User-Agent", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36");
    ...
    public void process(Page page) {
        try {
            ...
            if (!page.getHtml().xpath("//ul[@class='sellListContent']").match()) {
                ...
                log.info("================总页数：{} 当前页：{}=================", totalPage, count);
...
//                    List<Selectable> targets = page.getHtml().xpath("//li[@class='clear LOGCLICKDATA']").nodes();
                    ...
                    for (Selectable e : targets) {
                        try {
                            ...
                            String totalPrice = e.xpath("//div[@class='totalPrice']/span[1]/text()").toString();
                            ...
                            house.setTotalPrice(Double.valueOf(totalPrice));
            ...
            log.error("Function process() Exception,details:", e);
        }
    }
    ...
    public static void main(String[] args) {
        Spider.create(new HouseProcessor()).addUrl("https://zz.lianjia.com/ershoufang/erqi/pg1").thread(2).run();
    }
}
